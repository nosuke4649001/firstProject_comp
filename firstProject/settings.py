...
SECRET_KEY = 'django-insecure-rrierj6*4stjf90&5v!-s00(mo#0%jd!q$w(8#@idtoq$&e-k8'
...
DEFAULT_FROM_EMAIL = 'satoyukiti0505@gmail.com'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp.gmail.com'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'satoyukiti0505@gmail.com'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = 'xqiwajlfqygnutdw' # Gmailのアプリ用パスワードを入力
